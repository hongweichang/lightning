/*
 ...
 Source Server         : ligting
 Source Server Version : 50614
 Source Host           : 115.29.240.98
 Source Database       : lightning

 Target Server Version : 50614
 File Encoding         : utf-8

 Date: 11/23/2013 17:03:57 PM
*/
...
CREATE TABLE `xcms_bid` (
  ...
  `verify_progress` tinyint(1) unsigned NOT NULL DEFAULT '0' COMMENT '审核进度，0-审核中，1-通过，2-未通过',
...
CREATE TABLE `xcms_front_user` (
  `id` int(11) unsigned NOT NULL,
  `pay_password` varchar(60) DEFAULT NULL,
  ...
  `address` tinytext,
  `identity_id` varchar(18) DEFAULT NULL COMMENT '身份证，唯一',
  `bank` varchar(20) DEFAULT NULL,
  `role` varchar(15) DEFAULT NULL COMMENT '用户社会角色，字符串，方便阅读',
  `credit_acceptable` tinyint(1) NOT NULL DEFAULT '0' COMMENT '用户所属角色的资料是否填写完整，0-否，1-是，修改资料时置0，待审核',
  `credit_grade` int(4) NOT NULL DEFAULT '60' COMMENT '根据信用资料审核程度得到的分数',
  PRIMARY KEY (`id`),
...
-- ----------------------------
BEGIN;
INSERT INTO `xcms_front_user` VALUES ('21', '$2a$11$qSgyUuJAHFkFuhLidlFcK.d.fqoEGPbDAwNoOPKyqb2KxSo1wU/TG', '0', 'hehe', 'chenjunan', '1', '20', '13333333333', 'hehe@qq.com', null, '5111111', '6111111', 'role', '0', '60');
COMMIT;
...
) ENGINE=InnoDB AUTO_INCREMENT=22 DEFAULT CHARSET=utf8 COMMENT='网站用户表';

-- ----------------------------
--  Records of `xcms_user`
-- ----------------------------
BEGIN;
INSERT INTO `xcms_user` VALUES ('21', '$2a$11$y0s7qEmlL/.bT7Rkr4K0te6XkET/VCQQNNUdqRsaurQ66cmBnP7ga', '2cc47a09-7604-aa47-c228-dfea03a99504', '0', '0', '0', 'frontuser');
COMMIT;
