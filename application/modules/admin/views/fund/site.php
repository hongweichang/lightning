...
<div style="float:left;margin-left:100px;">
	...
	<p>平台收入总额：<?php echo number_format($income); ?></p>
	<p>第三方扣费总额总额：<?php echo number_format($recharge_fee); ?></p>
</div>
<div style="float:left;margin-left:100px;">
	借款统计：
	...
	<p>正在还款资金总额：<?php echo number_format($repaying,2); ?></p>
	<p>流标资金总额：<?php echo number_format($lose,2); ?></p>
	<p>逾期资金总额：<?php echo number_format($daly,2); ?></p>
</div>
