...
<form method="post" action="<?php echo $this->createUrl('account/register'); ?>" id="signup">
					<div class="form-item">
						...
						<input type="text" name="Register[nickname]" class="form-input" id="signup-nickname" value="" />
						<span class="user-ico"></span>
					</div>
					<div class="form-item">
						<label for="signup-email">邮箱</label>
						<input type="text" name="Register[email]" class="form-input" id="signup-email" value="" />
						<span class="user-ico"></span>
					</div>
					<div class="form-item">
						<label for="signup-phone">手机号</label>
						<input type="text" name="Register[mobile]" class="form-input" id="signup-phone" />
