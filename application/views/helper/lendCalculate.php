...
<div class="p2p-calc-content">
                ...
                <div class="section">
                    <form action="#" method="post" id="cal-form">
                        ...
                        <div class="calc-inf">
                            <input type="submit" value="开始计算" id="cal-submit" data-service="<?php echo $userCreditSettings['label'].';'.($userCreditSettings['on_loan']*100)?>" data-type="lend" />
                        </div>
                    </form>
                </div>
                ...
                <div class="calc-result">
                    ...
                    <table id="calc-rank">
                        ...
                        <tr>
                            <td>标段利息利润利率</td>
                            <?php foreach ( $creditSettings as $creditSetting ):?>
                            <td><?php echo $creditSetting['on_loan']?>%</td>
                            <?php endforeach;?>
                        </tr>
                        <tr>
